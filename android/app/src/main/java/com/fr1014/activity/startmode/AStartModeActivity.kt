...
const val SINGLE_TOP = 2;
const val SINGLE_TASK = 3;
const val SINGLE_INSTANCE = 4;

class AStartModeActivity : BaseActivity() {
...
//        val isStandardMode = flags and Intent.FLAG_ACTIVITY_NEW_TASK == 0 && flags and Intent.FLAG_ACTIVITY_CLEAR_TASK == 0
        ...
        if (isSingleInstanceMode) {
            return "Activity A SingleInstance"
        }
        return "Activity A Standard"
    }
}